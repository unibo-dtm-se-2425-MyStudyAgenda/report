...
The tool was used mainly for GUI design, since it was the author's first experience with Kivy framework. Also some UI's functions were implemented with the use of artificial intelligence.
...
All the suggestions provided by AI were reviewed, adapted and validated by the author, who takes full responsibility for the final implementation and for the accuracy and completeness of this report.
